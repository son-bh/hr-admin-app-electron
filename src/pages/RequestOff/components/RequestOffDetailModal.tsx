...
import type { IRequestOff } from '../../../types';
import { Modal } from '../../../components/ui/modal';
import Button from '../../../components/ui/button/Button';
import classNames from 'classnames';
import { StatusColor, StatusLabel } from '../../../shared/constants/common';
...
export default function RequestOffDetailModal({
  detail,
  isOpen,
  closeModal,
}: Props) {
      ...
      title={
        <>
          ...
          <p className='text-blue-100 text-sm'>
            Chi tiết thông tin đơn xin nghỉ
          </p>
        </>
      }
      footerContent={
          ...
          value={
            detail?.employee ? (
              <span className='font-semibold text-gray-800 dark:text-gray-200 leading-relaxed'>
                {detail.employee.username} - {detail.employee.email}
              </span>
            ) : (
              '—'
            )
